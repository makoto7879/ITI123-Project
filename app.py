...
print("="*60)
print("Loading ImprovedSPAMGRU Model...")
print("="*60)
...
with demo:
    gr.Markdown(
        ...
        ### ImprovedSPAMGRU - Now with Prize Scam & Phishing Detection! 🎣🎰
        
        **🎯 98.74% Base Accuracy** | **🔍 Advanced Pattern Recognition** | **🧠 Deep Learning**
    ...
    gr.Markdown(
        ...
        <b>ImprovedSPAMGRU </b> - Prize Scam & Phishing Detection 🎣🎰 | 
        Dataset: Spam Assassin (5,796 emails) | Base Accuracy: 98.74%
        </div>
        """
    )
