...
A deep learning-based spam detection system using Bidirectional GRU with Attention mechanism, achieving 98.74% test accuracy.
🎯 Overview
...
Upload Final ImprovedGRU model w WANDB.ipynb
...
📦 Project Structure
├── Final ImprovedGRU model w WANDB.ipynb  # Main training notebook
